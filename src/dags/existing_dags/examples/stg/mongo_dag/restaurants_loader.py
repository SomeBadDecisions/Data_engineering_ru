...
class RestaurantLoader:
    ...
    def __init__(self, collection_loader: RestaurantReader, pg_dest: PgConnect, restaurants_saver: RestaurantsSaver, logger: Logger) -> None:
        self.collection_loader = collection_loader
        self.restaurants_saver = restaurants_saver
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            i = 0
            for d in load_queue:
                self.restaurants_saver.save_object(conn, str(d["_id"]), d["update_ts"], d)
