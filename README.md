...
2. [Создание микросервисов](#Создание_микросервисов)
	1. [DDS](#DDS)
		...
		4. [DDS-сервис](#DDS-сервис)
			1. [Создание подключений](#Создание_подключений)
			2. [Работа с Postgres](#Работа_с_Postgres)
			3. [Работа_с_Kafka](#Работа_с_Kafka)
			4. [Основная логика](#Основная_логика)
	2. [CDM](#CDM)
			1. [Работа с Postgres](#Работа_с_Postgres)
			2. [Работа с Kafka](#Работа_с_Kafka)
3. [Выводы](#Выводы)
