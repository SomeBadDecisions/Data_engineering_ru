...
1 [Описание](#Описание)
2 [Создание микросервисов](#Создание микросервисов)
	2.1 [DDS](#DDS)
		2.1.1 [Docker-image](#Docker-image)
		2.1.2 [Docker-compose](#Docker-compose)
		2.1.3 [Helm-chart](#Helm-chart)
		2.1.4 [DDS-сервис](#DDS-сервис)
			2.1.4.1 [Создание подключений](#Создание подключений)
			2.1.4.2 [Работа с Postgres](#Работа с Postgres)
			2.1.4.3 [Работа с Kafka](#Работа с Kafka)
			2.1.4.4 [Основная логика](#Основная логика)
	2.2 [CDM](#CDM)
			2.2.1 [Работа с Postgres](#Работа с Postgres)
			2.2.2 [Работа с Kafka](#Работа с Kafka)
3 [Выводы](#Выводы)
...
## 2 Создание микросервисов <a name="Создание микросервисов"></a>
...
##### 2.1.4.1 Создание подключений <a name="Создание подключений"></a>
...
##### 2.1.4.2 Работа с Postgres <a name="Работа с Postgres"></a>
...
```
##### 2.1.4.3 Работа с Kafka <a name="Работа с Kafka"></a>
...
```
##### 2.1.4.4 Основная логика <a name="Основная логика"></a>
...
#### 2.2.1 Работа с Postgres <a name="Работа с Postgres"></a>
...
```
#### 2.2.2 Работа с Kafka <a name="Работа с Kafka"></a>
